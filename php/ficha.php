...
try {
    ...
    $result = $pdo->prepare(
        "INSERT INTO `tb_sheet` (`user_id`,`adventure`, `name`, `level`, `race`, `class`,`hp`, `hp_max`, `strength`, `dexterity`, `constitution`, `inteligence`, `wisdom`, `charisma`, `armor`, `initiative`, `force`, `reflex`, `will`, `strength_mod`, `dexterity_mod`, `constitution_mod`, `inteligence_mod`, `wisdom_mod`, `charisma_mod`, `abilities`, `weapons`, `skills`, `bag`) VALUE ($user_id ,'$adventure_id','$name', $level, '$race', '$class', $hp_max, $hp_max, $strength, $dexterity, $constitution, $intelligence, $wisdom, $charisma, $armor, $initiative, $force, $reflex, $will, $strength_mod, $dexterity_mod, $constitution_mod, $intelligence_mod, $wisdom_mod, $charisma_mod, '$abilities', '$weapons', '$skills', '$bag')"
    );
